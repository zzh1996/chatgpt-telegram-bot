...
MODELS = [
    {'prefix': 'x$', 'model': 'grok-4.7', 'prompt_template': ''},
    {'prefix': 'x46$', 'model': 'grok-4.6', 'prompt_template': ''},
    {'prefix': 'x45$', 'model': 'grok-4.5', 'prompt_template': ''},
    {'prefix': 'x43$', 'model': 'grok-4.3', 'prompt_template': ''},
    {'prefix': 'x42$', 'model': 'grok-4.20-0309-reasoning', 'prompt_template': ''},
    {'prefix': 'x41$', 'model': 'grok-4-1-fast-reasoning', 'prompt_template': ''},
    ...
    {'prefix': 'grok-3$', 'model': 'grok-3', 'prompt_template': ''},
    {'prefix': 'grok-3-mini$', 'model': 'grok-3-mini', 'prompt_template': ''},

    {'prefix': 'x2$', 'model': 'grok-2-1212', 'prompt_template': ''},
...
async def completion(chat_history, model, chat_id, msg_id, task_id): # chat_history = [user, ai, user, ai, ..., user]
    ...
    if model == 'grok-3-mini-beta' or model == 'grok-3-mini-fast-beta':
        stream = await aclient.chat.completions.create(model=model, messages=messages, stream=True, reasoning_effort="high")
    else:

...
MODELS = [
    ...
    {'prefix': 'db$', 'model': 'doubao-seed-2-1-pro-260915', 'prompt_template': ''},
    {'prefix': 'db21$', 'model': 'doubao-seed-2-1-pro-260628', 'prompt_template': ''},
...
async def completion(chat_history, model, chat_id, msg_id, task_id): # chat_history = [user, ai, user, ai, ..., user]
    ...
    kwargs = {}
    if model == 'doubao-seed-1-8-251228' or model.startswith('doubao-seed-2') or model == 'doubao-seed-evolving':

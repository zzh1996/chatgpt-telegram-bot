...
MODELS = [
    ...
    {'prefix': '54m$', 'model': 'gpt-5.4-mini-2026-03-17', 'prompt_template': ''},
    {'prefix': '54n$', 'model': 'gpt-5.4-nano-2026-03-17', 'prompt_template': ''},

    {'prefix': '53c$', 'model': 'gpt-5.3-chat-latest', 'prompt_template': ''},

    {'prefix': '52pro$', 'model': 'gpt-5.2-pro-2025-12-11', 'prompt_template': ''},
...
PRICING = {
    ...
    'gpt-5.2-pro-2025-12-11': (21, 168, 21, True),

    'gpt-5.3-chat-latest': (1.75, 14, 0.175, False),

    'gpt-5.4-2026-03-05': (2.5, 15, 0.25, True),
    'gpt-5.4-mini-2026-03-17': (0.75, 4.5, 0.075, True),
    'gpt-5.4-nano-2026-03-17': (0.2, 1.25, 0.02, True),

    'gpt-5.5-2026-04-23': (5, 30, 0.5, True),

    'gpt-5.6-sol': (4, 20, 0.4, True),
...
async def completion(chat_history, model, chat_id, msg_id, task_id, safety_identifier): # chat_history = [user, ai, user, ai, ..., user]
    ...
    support_reasoning_effort_max = model in ['gpt-5.6-sol', 'gpt-5.6-terra', 'gpt-5.6-luna'] or model.startswith('gpt-6')
    ...
    support_priority = model in ['gpt-5-2025-08-07', 'gpt-5-mini-2025-08-07', 'gpt-5.1-2025-11-13', 'gpt-5.2-2025-12-11', 'gpt-5.4-2026-03-05', 'gpt-5.4-mini-2026-03-17', 'gpt-5.5-2026-04-23', 'gpt-5.6-sol', 'gpt-5.6-terra', 'gpt-5.6-luna'] or model.startswith('gpt-6')

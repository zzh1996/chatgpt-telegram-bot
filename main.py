...
MODELS = [
    {'prefix': 'q$', 'model': 'qwen3.8-max', 'prompt_template': ''},
    {'prefix': 'q37$', 'model': 'qwen3.7-max', 'prompt_template': ''},
    ...
    {'prefix': 'q35$', 'model': 'qwen3.5-397b-a17b', 'prompt_template': ''},
    ...
    {'prefix': 'qwen-max-2024-04-28$', 'model': 'qwen-max-2024-04-28', 'prompt_template': ''},
    {'prefix': 'qwen-max-2024-04-03$', 'model': 'qwen-max-2024-04-03', 'prompt_template': ''},
    {'prefix': 'qwen-max-2024-01-07$', 'model': 'qwen-max-2024-01-07', 'prompt_template': ''},
    {'prefix': 'qwen-plus$', 'model': 'qwen-plus', 'prompt_template': ''},
    {'prefix': 'qwen-plus-latest$', 'model': 'qwen-plus-latest', 'prompt_template': ''},
    {'prefix': 'qwen-turbo$', 'model': 'qwen-turbo', 'prompt_template': ''},
    {'prefix': 'qwen-turbo-latest$', 'model': 'qwen-turbo-latest', 'prompt_template': ''},
    {'prefix': 'qwen-long$', 'model': 'qwen-long', 'prompt_template': ''},
    {'prefix': 'qwen-vl-max$', 'model': 'qwen-vl-max', 'prompt_template': ''},
    {'prefix': 'qwen-vl-max-latest$', 'model': 'qwen-vl-max-latest', 'prompt_template': ''},
    {'prefix': 'qwen-vl-plus$', 'model': 'qwen-vl-plus', 'prompt_template': ''},
    {'prefix': 'qwen-vl-plus-latest$', 'model': 'qwen-vl-plus-latest', 'prompt_template': ''},
    {'prefix': 'qwen-vl-ocr$', 'model': 'qwen-vl-ocr', 'prompt_template': ''},
    {'prefix': 'qwen-vl-ocr-latest$', 'model': 'qwen-vl-ocr-latest', 'prompt_template': ''},
    {'prefix': 'qwen-math-plus$', 'model': 'qwen-math-plus', 'prompt_template': ''},
    {'prefix': 'qwen-math-plus-latest$', 'model': 'qwen-math-plus-latest', 'prompt_template': ''},
    {'prefix': 'qwen-math-turbo$', 'model': 'qwen-math-turbo', 'prompt_template': ''},
    {'prefix': 'qwen-math-turbo-latest$', 'model': 'qwen-math-turbo-latest', 'prompt_template': ''},
    {'prefix': 'qwen-coder-plus$', 'model': 'qwen-coder-plus', 'prompt_template': ''},
    {'prefix': 'qwen-coder-plus-latest$', 'model': 'qwen-coder-plus-latest', 'prompt_template': ''},
    {'prefix': 'qwen-coder-turbo$', 'model': 'qwen-coder-turbo', 'prompt_template': ''},
    {'prefix': 'qwen-coder-turbo-latest$', 'model': 'qwen-coder-turbo-latest', 'prompt_template': ''},

    {'prefix': 'qwq$', 'model': 'qwq-32b', 'prompt_template': ''},
    {'prefix': 'qwq-plus$', 'model': 'qwq-plus', 'prompt_template': ''},
    {'prefix': 'qwq-plus-latest$', 'model': 'qwq-plus-latest', 'prompt_template': ''},
    {'prefix': 'qwq-32b-preview$', 'model': 'qwq-32b-preview', 'prompt_template': ''},
    ...
    {'prefix': 'qwen2$', 'model': 'qwen2-72b-instruct', 'prompt_template': ''},
    {'prefix': 'qwen15$', 'model': 'qwen1.5-110b-chat', 'prompt_template': ''},
...
VISION_REASONING_MODEL = 'qwen3.8-max'
    ...
    async for response in stream:
        ...
        if obj.delta.content is not None:
            if isinstance(obj.delta.content, list):
                ...
                yield {'type': 'text', 'text': obj.delta.content[0]['text']}
            else:
